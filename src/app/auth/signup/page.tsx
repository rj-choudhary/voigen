...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store additional form data in localStorage for later use
      ...
      localStorage.setItem('signupData', JSON.stringify(additionalData));
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      // Store that user is signing up (not just signing in)
