...
export const metadata: Metadata = {
  title: 'Contact Us - Get in Touch | Voigen',
  description: 'Contact Voigen for AI voice agent solutions. Get a demo, ask questions, or start your free trial. We respond within 24 hours.',
  keywords: ['contact Voigen', 'Voigen support', 'AI voice agent demo', 'Voigen sales'],
  openGraph: {
    title: 'Contact Voigen - AI Voice Agent Solutions',
    description: 'Get in touch with our team. We\'d love to help transform your business communications with AI.',
    url: 'https://voigen.ai/contact-us',
    type: 'website',
  },
  alternates: {
    canonical: 'https://voigen.ai/contact-us',
  },
};
